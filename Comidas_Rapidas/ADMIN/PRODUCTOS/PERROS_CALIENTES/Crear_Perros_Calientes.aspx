<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="Crear_Perros_Calientes.aspx.cs" Inherits="Comidas_Rapidas.ADMIN.PRODUCTOS.PERROS_CALIENTES.Crear_Perros_Calientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content">
        <h3 class="text-center">PERROS CALIENTES   DISPONIBLES</h3>
        <div class="row">
