<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="Crear_Pollo_Bros.aspx.cs" Inherits="Comidas_Rapidas.ADMIN.PRODUCTOS.POLLO_BROASTER.Crear_Pollo_Bros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content">
        <h3 class="text-center">POLLOS BROASTER DISPONIBLES</h3>
        <div class="row">
