<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador.Master" AutoEventWireup="true" CodeBehind="Consultar_Crear_Asados.aspx.cs" Inherits="Comidas_Rapidas.ADMIN.PRODUCTOS.ASADOS.Consultar_Crear_Asados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content">
        <h3 class="text-center">ASADOS DISPONIBLES</h3>
        <div class="row">
