<%@ Page Title="" Language="C#" MasterPageFile="~/Productos.Master" AutoEventWireup="true" CodeBehind="Pollo_Broaster_Disponibles.aspx.cs" Inherits="Comidas_Rapidas.Willys_Inicio.PRODUCTOS.Pollo_Broaster_Disponibles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <h3 class="text-center">POLLO BROASTER DISPONIBLES</h3>
        <div class="row">
