<%@ Page Title="" Language="C#" MasterPageFile="~/Productos.Master" AutoEventWireup="true" CodeBehind="Salchipapas_Disponibles.aspx.cs" Inherits="Comidas_Rapidas.Willys_Inicio.PRODUCTOS.Salchipapas_Disponibles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
        <h3 class="text-center">SALCHIPAPAS DISPONIBLES</h3>
        <div class="row">
